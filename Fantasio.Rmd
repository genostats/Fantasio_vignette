...
In the call to Fantasio, we can pass a list of options for the segment
construction ; here we pass `hotspots = hotspot_hg18`, as the HGDP-CEPH
SNP positions are on the hg18/b36 reference as mentionned above.

Among the slots containg results of interest, the slot `F1@marker_summary`
gives **to be completed**
