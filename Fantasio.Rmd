...
Fantasio also computes the likelihood of a mating type. These likelihoods can be used for:
...
* ped  : which gives you informations about all the individuals in the chip 
...
* By "Hotspots" : 
    *With this method we use a hotspots files to segment our genome, each segment contains several markers.
